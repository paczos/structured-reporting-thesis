...
\usepackage{listings}
\usepackage{xcolor}
\usepackage{fancyhdr} %footer settings
...
\begin{abstract}
	System do tworzenia strukturalnych opisów radiologicznych
	\\
...
\includepdf[pages={1,2}]{author_statement}
\tableofcontents
\clearpage
...
\begin{figure}
    \centering
    \includegraphics[width=0.25\linewidth]{report-semantic.pdf}
...
\begin{center}
    ...
    \end{center}
    \footnotetext[1]{For simplicity, only names of nodes are presented (associated meta-data entries were omitted).}
\end{minipage}
\end{figure}
...
\begin{figure}
    ...
    \caption{GUI used to edit properties of an organ\protect\footnotemark[2] \label{fig:template-property-list}}
    	\end{center}
    \footnotetext[2]{User can predefine connotation and signify that this property can be automatically included if the organ is marked as healthy.}
    \end{minipage}
\end{figure}
...
\begin{comment}%removed because of hiding Adaptation of medical innovations in Poland
...
\begin{comment}%removed because of hiding Adaptation of medical innovations in Poland
\bibitem{inefficient}
 Dunlevy, Inefficient public hospitals wasting \$1 billion, finds Grattan Institute report, available at: \\ http://www.news.com.au/lifestyle/health/inefficient-public-hospitals-wasting-1-billion-finds-grattan-institute-report/news-story/7aed1d890868572790cdc2a2a04c7868 [10.03.2018]
 \end{comment}
