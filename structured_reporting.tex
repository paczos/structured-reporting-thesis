...
\begin{abstract}
	Projekt oraz implementacja systemu wspomagającego tworzenie strukturalnych opisów radiologicznych. Oprogramowanie ma celu zwiększenie produktywności lekarza i zmniejszenie ryzyka popełnienia błędu poprzez sugerowanie zbiorów standardowych, najczęściej występujących fraz opisującyh dokładnie stan pacjenta.
\\
...
\bibitem{microsoft-json-suppoert} Popovic, JSON support in SQL Server 2016, available at: \\
