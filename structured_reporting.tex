...
Figure \ref{fig:continuous-deployment} presents the sequence of actions that are 
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{continuous-deployment}
	\caption{Sequence of actions that are executed to maintain good quality of the codebase.
