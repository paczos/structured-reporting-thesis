...
Structured reporting system is being used by several independent teleradiologists in Poland as their main text editing tool. They receive reporting requests with images they are asked to describe. They use several different RIS systems to store reports they generate. Most of them simply copy and paste reports from the System to the RIS systems they use. The following paragraph is a
...
\blockquote{
Health informatics is currently present in almost every activity carried out when examining state of patient’s body as techniques used in modern medicine generate a lot of data that must be presented to a proper person at proper time.
